...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <style>
        ...
        .jssorb132 .i .b {fill:#fff;fill-opacity:0.8;stroke:#000;stroke-width:1650;stroke-miterlimit:10;stroke-opacity:0.7;}
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1380px;height:560px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1650px;height:560px;overflow:hidden;">
        ...
        <div class="container py-md-3">
           ...
           <div class="main-cont-wthree-fea row ">
                ...
                <div class="grids-speci1 las-but col-lg-3 col-6  mt-lg-0 mt-4">
                    <div class="spec-2 text-center">
                        <span class="fa fa fa-user-lock"></span>
    ...
    <div class="row" class="side">
        <div class="col">
        <h6>Client Success Story</h6><br>
           <div class="video">
                <iframe width="530" height="345" class="embed-responsive-item" src="https://www.youtube.com/embed/tgbNymZ7vqY" allowfullscreen></iframe>
            </div>
        </div>
        <div class="col">
            <p>Our design teams help our clients through the digital design and strategy maze.</p><br>
            <p>We are proud to be a customer-centric company. For your success in the digital transformation, we ensure the fastest delivery with 360 solutions & services. </p><br>
            <p>We are proud to be a customer-centric company. For your success in the digital transformation, we ensure the fastest delivery with 360 solutions & services. </p><br>
            <p>But interaction design is our passion. It is one place we never compromise. There is only one option for software interfaces: simple. Over the years we have become very good at this art of making the complex simple. </p><br>
            <p>To see all of our services please &nbsp;&nbsp;<a href="{{ url('/casestudies') }}" class="btn btn-info">Click Here..</a></p><br>
            <p class="email">Want to find out more?</p>
            <p class="email">email us: <a href="#">info@digitalvai.com.bd</a></p>
        </div>
    </div>
   </div><br><br>
   <section class="w3l-bottom-grids-6 py-5">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-5" style="max-width:500px;">
                <h2>We are the best It Specialist Around You</h2>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 grids-feature">
                    <div class="area-box">
                        <i class="fas fa-user-lock"></i>
                        <h4><a href="about.php" class="title-head">Strong Security</a></h4>
                ...
                <div class="col-lg-4 col-md-6 grids-feature mt-5">
                    <div class="area-box">
                        ...
                        <h4><a href="about.php" class="title-head">Creative Idea</a></h4>
                        <p class="">Amus a ligula quam tesque et libero ut justo, ultrices in. Ut eu leo non. Duis
                            sed dolor et amet.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-5">
                    <div class="area-box">
                        ...
                        <h4><a href="about.php" class="title-head">Best Service</a></h4>
                        <p class="">Amus a ligula quam tesque et libero ut justo, ultrices in. Ut eu leo non. Duis
                            sed dolor et amet.</p>
                    </div>
                </div>
    ...
    <section class="w3l-about-2 py-5">
        <div class="container py-md-5 py-4">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6 about-2-secs-right mb-lg-0 mb-5" id="best">
                    <img src="images/help.jpg" alt="" class="img-fluid img-responsive" />
                </div>
                <div class="col-lg-6 about-2-secs-left mt-lg-0 mt-sm-4 mt-2 pl-lg-5">
                    <div class="style-title position-relative">
                        <h5>We are the best Place to Improve Your Work
                        </h5>
                    </div>
                    <p>A place of trust...</p>
                    <div class="w3l-progressblock mt-md-5 mt-4">
                        <div class="progress-info info1">
                            <h6 class="progress-tittle">Software Support<span class="">95%</span></h6>
                            <div class="progress">
                        ...
                        <div class="progress-info info2">
                            <h6 class="progress-tittle">Digital Marketing<span class="">85%</span>
                            </h6>
                            <div class="progress">
                        ...
                        <div class="progress-info info3 mb-0">
                            <h6 class="progress-tittle">Training Courses<span class="">90%</span></h6>
                            <div class="progress">
    ...
    <section class="w3l-team py-5">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-5" style="max-width:500px;">
                <p class="text-uppercase">Management Profiles</p>
                <h3 class="title-style">Meet our <span>Managements!</span></h3>
            </div>
            <div class="row text-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="team-block-single">
                        <div class="team-grids">
                            <a href="#team-single">
                                <img src="assets/images/shamim.jpg" class="img-fluid" alt="">
                            </a>
                            <div class="team-info">
                        ...
                        <div class="team-bottom-block p-4">
                            <h5 class="member mb-1"><a href="#team">MD Shamim Reza</a></h5>
                            <small>CEO of the Company</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mt-5">
                    <div class="team-block-single">
                        ...
                        <div class="team-bottom-block p-4">
                            <h5 class="member mb-1 active"><a href="#team">Sadaf Zaman</a></h5>
                            <small>Co-founder and Chirman of the Company</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="team-block-single">
                        <div class="team-grids">
                            <a href="#team-single">
                                <img src="assets/images/Nayem.jpg" class="img-fluid" alt="">
                            </a>
                            <div class="team-info">
                                <div class="social-icons-section">
                                    <a class="fac" href="#facebook">
                        ...
                        <div class="team-bottom-block p-4">
                            <h5 class="member mb-1"><a href="#team">MD. NAYEM</a></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-6 column pl-lg-0">
                            ...
                            <ul class="footer-contact-list">
                                ...
                                <li class="mt-2"><a href="mailto:info@example.com">info@digitalvai.com</a></li>
                                <li class="mt-2"><a href="mailto:info@example.com">www.digitalvai.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
