...
<div class="wrapper rounded bg-white">
	...
	<center><img src="images/addproduct.png" alt="Image" class="img-fluid" width="200" height="150"/></center>
        ...
        <div class="row">
            <div class="col-md-6 mt-md-0 mt-3"> <label>Price LP</label> <input type="number" step="any" name="buyingprice" placeholder="Price LP" class="form-control" required> </div>
        ...
        <div class="row">
            <div class="my-md-2 my-3"> <label>Price TP</label> <input type="number" step="any" name="updated_price" placeholder="Price TP" class="form-control" required> </div>
        </div>
        <div class="row">
